...
<head>
    ...
    <link rel="stylesheet" href="/css/inicio_sesion/superadmin/distribuidor.css?v=<?= time() ?>">
...
<body>
    ...
    <!-- TITULO INICIO SESION Y VALIDACION-->
        ...
        // Incluye el archivo log_registros.php donde se encuentra la función logger()
                require_once __DIR__ . '/../seguridad/log_registros.php';

        // Validación: solo admin
        if (empty($accesoDesdeMenu) && (!isset($_SESSION['correo']) || $_SESSION['rol'] !== 'admin')) {
    ...
    <!-- TITULO ARCHIVO JS -->
        ...
        <!-- Enlace al archivo JavaScript específico del módulo admin -->
        <script src="/js/inicio_sesion/superadmin/admin.js?v=<?= time() ?>"></script>
