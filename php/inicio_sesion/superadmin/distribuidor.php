...
<!-- ------------------------------------------------------------------------------------------------------------
     ------------------------------------- INICIO ITred Spa distribuidor .PHP ------------------------------------------
     ------------------------------------------------------------------------------------------------------------ -->
...
<body>
    ...
    <!-- TITULO INICIO SESION Y VALIDACION-->
        ...
        // Validación: solo distribuidor
        if (empty($accesoDesdeMenu) && (!isset($_SESSION['correo']) || $_SESSION['rol'] !== 'distribuidor')) {
        ...
        $_SESSION['vista'] = 'distribuidor.php';
    ...
    <!-- TITULO ARCHIVO JS -->
        ...
        <!-- Enlace al archivo JavaScript específico del módulo distribuidor -->
        <script src="/js/inicio_sesion/superadmin/distribuidor.js?v=<?= time() ?>"></script>
...
<!-- ------------------------------------------------------------------------------------------------------------
     -------------------------------------- FIN ITred Spa distribuidor .PHP --------------------------------------------
     ------------------------------------------------------------------------------------------------------------ -->
<!--
Sitio Web Creado por ITred Spa.
Direccion: Guido Reni #4190
